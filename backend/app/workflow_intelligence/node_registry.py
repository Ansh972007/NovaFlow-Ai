...
BUILTIN_NODE_SCHEMAS: dict[str, dict[str, Any]] = {
    "trigger": {
        ...
        "category": "builtin",
        "icon": "trigger",
        "description": "Single entry point — manual runs, webhooks, Telegram, email, and schedules all start here.",
        "fields": [
            ...
            _field(
                ...
                "textarea",
                placeholder="One trigger handles all channels — connect Telegram/Email nodes downstream.",
            ),
            _field(
                "webhook_hint",
                "Webhook note",
    ...
    "llm": {
        ...
        "fields": [
            ...
            _field(
                ...
                "credential",
                vault_category="llm",
                placeholder="Uses default model provider if empty",
            ),
            _field(
                "user_prompt",
    ...
    "notify": {
        ...
        "fields": [
            ...
            _field(
                ...
                default="oauth",
                options=[
                    {"value": "oauth", "label": "Google OAuth (Gmail API)"},
            ...
            _field(
                "from",
                "From (sender email)",
                show_when={"channel": "email", "auth_mode": "smtp"},
            ...
            _field(
                ...
                show_when={"channel": "email"},
                default="{{subject}}",
                placeholder="{{subject}} — generated by LLM or custom text",
            ),
            _field(
                "message",
                "Email body",
            ...
            _field(
                ...
                "credential",
                show_when={"channel": "email", "auth_mode": "oauth"},
                vault_category="email",
                vault_kind="gmail_oauth",
            ),
            _field(
                "to",
                "Chat ID",
