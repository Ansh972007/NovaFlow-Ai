...
RECIPES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "match": ("google drive", "gdrive", "drive sync"),
        "any_of": ("google drive", "gdrive", "sync drive", "drive files"),
        "caps": ["cap_google", "cap_workflow"],
        "field": "ops",
        "description": "List or sync Google Drive files via API",
    },
    {
    ...
    {
        "id": "crm_webhook_lead",
        "name": "CRM Webhook Lead",
        "match": ("crm", "hubspot", "salesforce", "lead webhook"),
        "any_of": ("crm webhook", "hubspot", "salesforce lead", "crm lead", "lead to crm"),
        "caps": ["cap_http", "cap_workflow", "cap_slack"],
        "field": "sales",
        "description": "Normalize lead input and POST to CRM webhook",
    },
    {
        "id": "outlook_mail",
        "name": "Outlook Mail",
