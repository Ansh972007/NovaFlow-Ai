...
export default function AuthFormPanel({
  ...
  const showPasswordForm = passwordLogin !== false || ldapEnabled || isRegister;
  const showOAuth = providers.length > 0 || !!googleProvider || samlEnabled;
  const showOAuthConfigWarning = !loadingProviders && !showPasswordForm && !googleProvider && gmailOnly;
