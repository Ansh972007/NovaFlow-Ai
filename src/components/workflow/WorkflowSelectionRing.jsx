...
const RING_COLORS = {
  ...
  jira: { stroke: "#3b82f6", glow: "rgba(59,130,246,0.35)", dot: "#60a5fa" },
  github: { stroke: "#171717", glow: "rgba(23,23,23,0.3)", dot: "#525252" },
  linear: { stroke: "#6366f1", glow: "rgba(99,102,241,0.35)", dot: "#818cf8" },
